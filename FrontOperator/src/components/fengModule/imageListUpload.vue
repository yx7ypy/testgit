<template>
	<div>
		<el-upload :action="actionUrl" list-type="picture-card" :on-preview="handlePictureCardPreview" :on-remove="handleRemove" :before-upload="beforeAvatarUpload" :on-success="handleAvatarScucess" :on-error="handleAvatarError">
	...
	export default {
		data() {
			return {
				dialogVisible: false,
				dialogImageUrl: [],
				actionUrl: basicConfig.UPLOAD_IMG_HOST,
				imageMax: 0
			}
		},
		methods: {
